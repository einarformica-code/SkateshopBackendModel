...
public class Board extends Product {
	 ...
	 * @param stock
	 */
    public Board(String id, String brand, double price, int stock, double width) {
    ...
    @Override public String getType() { return "BOARD"; }
    ...
    public String toFileString() {
        return String.format("BOARD|%s|%s|%.2f|%d|%.2f",
